                    ...
                    <div>
                        <a href="/">
                            <div class="flex items-center space-x-2 text-2xl font-medium">
                                <span>
                                    <img src="https://www.svgrepo.com/show/522813/crop.svg" alt="App Logo"
                                        width="64" height="64" class="w-16 text-white bg-white rounded-lg shadow-md">
                                </span>
                                <span class="text-white">RemoveBackground</span>
                            </div>
                    ...
                    <div class="md:grid md:grid-cols-2 md:gap-8">
                        <div>
                            ...
                            <ul role="list" class="mt-6 space-y-4">
                                <li>
                                    <a href="/aiplatform"
                                        class="text-md leading-6 text-slate-500 hover:text-gray-50">AI Platform
                                    </a>
                                </li>
                                <li>
                                    <a href="/aialgorithms"
                                        class="text-md leading-6 text-slate-500 hover:text-gray-50">AI Algorithms
                                    </a>
                                </li>
                                <li>
